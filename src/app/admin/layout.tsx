...
export default async function AdminLayout({
  ...
  const profileValue = profile as
    | { is_admin?: boolean | null; is_super_admin?: boolean | null; role?: string | null }
    | null;
    ...
    return (
      <div className="mx-auto w-full max-w-6xl px-4 py-10">
        <Card className="p-8">
          ...
          <div className="mt-1 text-sm text-muted-foreground">
            {!profileValue
              ? "Your profile row was not found, so the app cannot verify admin access."
